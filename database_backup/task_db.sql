...
INSERT INTO `items_list` VALUES (1,'book',453,'../images/1.jpg'),(2,'car',443,'../images/2.jpg'),(3,'notebook',449,'../images/3.jpg');
...
--
-- Dumping data for table `money_balance`
--

LOCK TABLES `money_balance` WRITE;
/*!40000 ALTER TABLE `money_balance` DISABLE KEYS */;
INSERT INTO `money_balance` VALUES (1,42327);
/*!40000 ALTER TABLE `money_balance` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `users` (
  ...
  `loyalty_point_amount` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `users` VALUES (2,'admin','1',6443,341010);
...
-- Dump completed on 2018-10-08  5:38:26
